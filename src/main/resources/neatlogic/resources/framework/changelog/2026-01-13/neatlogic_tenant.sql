CREATE TABLE `user_export_file` (
    ...
    `type` varchar(200) COLLATE utf8mb4_general_ci NOT NULL COMMENT '功能类型',
    `content_type` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'mime类型',
