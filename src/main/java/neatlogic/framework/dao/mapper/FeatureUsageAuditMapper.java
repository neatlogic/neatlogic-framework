...
public interface FeatureUsageAuditMapper {

    int getFeatureUsageAuditCount(FeatureUsageAuditSearchVo searchVo);

    List<FeatureUsageAuditVo> getFeatureUsageAuditList(FeatureUsageAuditSearchVo searchVo);

    int getFeatureCount(FeatureUsageAuditSearchVo searchVo);
