...
public class TestPublicJob3 extends JobBase implements IPublicJob {

	private Logger logger = LoggerFactory.getLogger(TestPublicJob3.class.getName());
