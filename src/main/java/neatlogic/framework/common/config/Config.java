...
public class Config {
    ...
    private static String SSO_AUTH_PLUGIN_KEY;//sso免登录，url中获取认证插件的参数名
    ...
    public static String LOGIN_AUTH_HANDLER(){
        return LOGIN_AUTH_HANDLER;
    }
    ...
    public static String SSO_AUTH_PLUGIN_KEY(){
        return SSO_AUTH_PLUGIN_KEY;
    }
    ...
    private static void loadNacosProperties(String configInfo) {
        try {
            ...
            SSO_AUTH_PLUGIN_KEY = prop.getProperty("sso.auth.plugin.key");
