...
public class TestPublicJob10 extends JobBase implements IPublicJob {

	private Logger logger = LoggerFactory.getLogger(TestPublicJob10.class.getName());
