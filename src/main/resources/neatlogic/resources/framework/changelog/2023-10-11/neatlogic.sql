...
CREATE TABLE `tenant_module_dmlsql_detail`  (
  `sql_uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'sql 唯一标识hash',
  `content` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'sql 语句',
  PRIMARY KEY (`sql_uuid`) USING BTREE
