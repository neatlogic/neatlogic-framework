...
public class TestPublicJob7 extends JobBase implements IPublicJob {

	private Logger logger = LoggerFactory.getLogger(TestPublicJob7.class.getName());
