...
public class TestPublicJob4 extends JobBase implements IPublicJob {

	private Logger logger = LoggerFactory.getLogger(TestPublicJob4.class.getName());
...
//		}
	...
	public String getJobClassName() {
		return "测试TestPublicJob4";
	}

	@Override
	public String getType() {
		return JobClassVo.TASK_TYPE;
	}
