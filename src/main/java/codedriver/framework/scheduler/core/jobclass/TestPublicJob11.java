...
public class TestPublicJob11 extends JobBase implements IPublicJob {

	private Logger logger = LoggerFactory.getLogger(TestPublicJob11.class.getName());
