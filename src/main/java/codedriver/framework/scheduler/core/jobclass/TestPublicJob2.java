...
public class TestPublicJob2 extends JobBase implements IPublicJob {

	private Logger logger = LoggerFactory.getLogger(TestPublicJob2.class.getName());
