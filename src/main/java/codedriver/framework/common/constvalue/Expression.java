...
public enum Expression implements IEnum{
	...
	private Expression(String _expression, String _expressionName, String _expressionEs,String _expressionSql ,Integer _isShowConditionValue) {
	...
	public static String getExpressionSql(String _expression) {
		for (Expression s : Expression.values()) {
			if (s.getExpression().equals(_expression)) {
				return s.getExpressionSql();
			}
		}
		return null;
	}
