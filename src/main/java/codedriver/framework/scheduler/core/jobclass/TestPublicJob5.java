...
public class TestPublicJob5 extends JobBase implements IPublicJob {

	private Logger logger = LoggerFactory.getLogger(TestPublicJob5.class.getName());
