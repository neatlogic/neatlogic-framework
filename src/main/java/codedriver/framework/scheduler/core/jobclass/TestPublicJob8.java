...
public class TestPublicJob8 extends JobBase implements IPublicJob {

	private Logger logger = LoggerFactory.getLogger(TestPublicJob8.class.getName());
