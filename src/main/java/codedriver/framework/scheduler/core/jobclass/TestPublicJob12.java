...
public class TestPublicJob12 extends JobBase implements IPublicJob {

	private Logger logger = LoggerFactory.getLogger(TestPublicJob12.class.getName());
