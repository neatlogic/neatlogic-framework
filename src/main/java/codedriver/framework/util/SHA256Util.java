...
public class SHA256Util {
    ...
    public static void main(String[] a) {
        System.out.println(encrypt("abd", "admin#/codedriver/api/rest/testhmac#" + Base64.encodeBase64StringUnChunked("{\"id\":379606793519104,\"ciEntityId\":371583055765506}".getBytes(StandardCharsets.UTF_8))));
    }
