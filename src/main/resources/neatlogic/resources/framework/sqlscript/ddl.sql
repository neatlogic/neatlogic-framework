...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '数据仓库-数据源';
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '数据仓库-数据源审计';
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '数据仓库-数据源-条件';
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '数据仓库-数据源-字段';
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '数据仓库-数据源-参数';
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '全局引用关系表';
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '表单实例属性当前值';
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '自定义表单属性表';
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '表单版本扩展属性';
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '表单实例扩展属性当前值';
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'globalsearch_document';
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'globalsearch_document_field';
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'globalsearch_document_offset';
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'rebuild_audit';
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = 'CMDB自定义视图矩阵配置表';
...
(
    ...
    `handler`     varchar(50) COLLATE utf8mb4_general_ci                       NOT NULL               DEFAULT 'artemis' COMMENT '消息队列类型',
    PRIMARY KEY (`id`) USING BTREE,
...
(
    ...
    `handler`   varchar(50) COLLATE utf8mb4_general_ci  DEFAULT NULL COMMENT '消息队列类型',
    PRIMARY KEY (`name`) USING BTREE
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4
...
(
  ...
  CHARACTER SET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '地域表';
...
(
  ...
  AUTO_INCREMENT = 933806994210819
  CHARACTER SET = utf8mb4
...
(
  ...
  AUTO_INCREMENT = 1136039253884929
  CHARACTER SET = utf8mb4
...
(
  ...
  AUTO_INCREMENT = 1102688899940353
  CHARACTER SET = utf8mb4
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='用户会话';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT = '首页设置表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='首页设置授权表';
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_general_ci COMMENT ='租户服务器运行时间表';