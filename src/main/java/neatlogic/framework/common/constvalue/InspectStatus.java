...
public enum InspectStatus implements IEnum {
    NORMAL("normal", new I18n("common.inspectstatus.normal"), "text-success"),
    WARN("warn", new I18n("common.inspectstatus.warn"), "text-warning"),
    CRITICAL("critical", new I18n("common.inspectstatus.critical"), "text-error"),
    FATAL("fatal", new I18n("common.inspectstatus.fatal"), "text-error");
