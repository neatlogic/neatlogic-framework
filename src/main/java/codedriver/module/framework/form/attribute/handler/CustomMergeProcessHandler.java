        ...
        if (api != null) {
            ...
            if (restComponent != null) {
                ...
                try {
                    ...
                    JSONArray tbodyArray = (JSONArray) restComponent.myDoService(paramObj);
                    for (int i = 0; i < tbodyArray.size(); i++) {
                        ...
                        tbody.put("serialNumber", tbodyObj.getString("serialNumber"));
                        tbody.put("title", tbodyObj.getString("title"));
                        String owner = tbodyObj.getString("owner");
                        if (StringUtils.isNotBlank(owner)) {
                            tbody.put("owner", owner);
                            ownerList.add(owner);
                        }
                        Date startTime = tbodyObj.getDate("startTime");
