...
public class NotifyPolicyUtil {
	...
	* @return void
	 */
	public static void execute(NotifyPolicyConfigVo policyConfig, List<ParamMappingVo> paramMappingList, INotifyTriggerType notifyTriggerType, JSONObject templateParamData, JSONObject conditionParamData, Map<String, List<NotifyReceiverVo>> receiverMap) {
		/** 异常通知用户uuid列表 **/
