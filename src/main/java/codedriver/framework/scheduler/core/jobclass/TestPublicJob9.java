...
public class TestPublicJob9 extends JobBase implements IPublicJob {

	private Logger logger = LoggerFactory.getLogger(TestPublicJob9.class.getName());
