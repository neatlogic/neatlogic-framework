...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '接口表';
...
CREATE TABLE IF NOT EXISTS `api_access_count`  (
  ...
  PRIMARY KEY (`token`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '接口访问次数表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '接口记录表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '控制所有审计的配置信息';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '接口文件表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '视图信息表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据仓库-数据源审计';
...
CREATE TABLE IF NOT EXISTS `datawarehouse_datasource_condition`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据仓库-数据源-条件';
...
CREATE TABLE IF NOT EXISTS `datawarehouse_datasource_field`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据仓库-数据源-字段';
...
CREATE TABLE IF NOT EXISTS `datawarehouse_datasource_param`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_datasource_id`(`datasource_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '数据仓库-数据源-参数';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '全局引用关系表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '附加菜单表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '附加菜单授权表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '上传文件信息表';
...
CREATE TABLE IF NOT EXISTS `filetype_config`  (
  ...
  PRIMARY KEY (`name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文件类型配置表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '表单';
...
CREATE TABLE IF NOT EXISTS `form_attribute`  (
  ...
  `key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '属性英文名',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '表单版本属性';
...
CREATE TABLE IF NOT EXISTS `form_attribute_data`  (
  ...
  `attribute_key` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '属性英文名',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '表单实例属性当前值';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '表单属性引用矩阵关系表';
...
CREATE TABLE IF NOT EXISTS `form_customitem`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_name`(`name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '自定义表单属性表';

-- ----------------------------
-- Table structure for form_extend_attribute
-- ----------------------------
CREATE TABLE IF NOT EXISTS `form_extend_attribute`  (
  `form_uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '表单uuid',
  `formversion_uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '表单版本uuid',
  `parent_uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '属性父级uuid',
  ...
  `handler` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '属性处理器',
  `config` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '属性配置',
  PRIMARY KEY (`form_uuid`, `formversion_uuid`, `tag`, `uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '表单版本扩展属性';

-- ----------------------------
-- Table structure for form_extend_attribute_data
-- ----------------------------
CREATE TABLE IF NOT EXISTS `form_extend_attribute_data`  (
  ...
  `data` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '属性值,json格式',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '表单实例扩展属性当前值';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '表单版本';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '索引重建日志';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'wordbook';
...
CREATE TABLE IF NOT EXISTS `global_lock`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_uuid`(`uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '全局锁';
...
CREATE TABLE IF NOT EXISTS `globalsearch_document`  (
  ...
  `target_id` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'target_id',
  `type` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '类型',
  `hit_count` int NULL DEFAULT NULL COMMENT '搜索命中次数',
  `click_count` int NULL DEFAULT NULL COMMENT '搜索后点击次数',
  `fcd` timestamp(3) NULL DEFAULT NULL COMMENT 'fcd',
  `lcd` timestamp(3) NULL DEFAULT NULL COMMENT 'lcd',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `idx_targetid`(`target_id`, `type`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'globalsearch_document';
...
CREATE TABLE IF NOT EXISTS `globalsearch_document_field`  (
  ...
  `field` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '字段',
  `type` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '类型',
  ...
  INDEX `idx_word`(`word_id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'globalsearch_document_field';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'globalsearch_document_offset';
...
CREATE TABLE IF NOT EXISTS `globalsearch_rebuild_audit`  (
  ...
  `status` enum('doing','done') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'status',
  `start_time` timestamp(3) NULL DEFAULT NULL COMMENT 'start_time',
  `end_time` timestamp(3) NULL DEFAULT NULL COMMENT 'end_time',
  `editor` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'editor',
  `server_id` int NULL DEFAULT NULL COMMENT 'server_id',
  PRIMARY KEY (`type`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'rebuild_audit';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '集成配置表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'integration_audit';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '集成配置接口调用表';
...
CREATE TABLE IF NOT EXISTS `lock`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '专门用来放锁的表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '登录验证码表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '登录失败次数';
...
CREATE TABLE IF NOT EXISTS `mail_server`  (
  ...
  PRIMARY KEY (`uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '邮件服务器表';
...
) ENGINE = InnoDB AUTO_INCREMENT = 507 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '矩阵信息表';
...
CREATE TABLE IF NOT EXISTS `matrix_attribute`  (
  ...
  `unique_identifier` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '属性唯一标识',
  `sort` int NULL DEFAULT NULL COMMENT '排序',
  `config` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '属性配置',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `matrix_attribute_key`(`matrix_uuid`, `uuid`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1101 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '矩阵自定义属性表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'cmdb模型矩阵';
...
CREATE TABLE IF NOT EXISTS `matrix_cmdb_custom_view`  (
  ...
  `config` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '配置信息',
  PRIMARY KEY (`matrix_uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'CMDB自定义视图矩阵配置表';
...
CREATE TABLE IF NOT EXISTS `matrix_external`  (
  ...
  PRIMARY KEY (`matrix_uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '矩阵外部数据源配置信息表';
...
CREATE TABLE IF NOT EXISTS `matrix_view`  (
  ...
  PRIMARY KEY (`matrix_uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '矩阵视图表';
...
CREATE TABLE IF NOT EXISTS `menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单表';
...
CREATE TABLE IF NOT EXISTS `menu_mobile`  (
  ...
  `sort` int NULL DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '移动菜单';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单角色表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '消息详情表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '消息接收者表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '消息订阅表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户消息状态表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'mq订阅表';
...
CREATE TABLE IF NOT EXISTS `mq_topic`  (
  ...
  PRIMARY KEY (`name`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'mq主题表';
...
CREATE TABLE IF NOT EXISTS `notify_config`  (
  ...
  PRIMARY KEY (`type`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '通知配置表';
...
CREATE TABLE IF NOT EXISTS `notify_job`  (
  ...
  `lcu` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '通知定时任务表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '通知定时任务接收者表';
...
CREATE TABLE IF NOT EXISTS `notify_policy`  (
  ...
  `lcu` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '通知策略信息表';
...
CREATE TABLE IF NOT EXISTS `region`  (
  ...
  `worktime_uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '服务窗口uuid',
  `is_active` int NULL DEFAULT 1 COMMENT '是否启用',
  `lft` int NULL DEFAULT NULL COMMENT '左编码',
  `rht` int NULL DEFAULT NULL COMMENT '右编码',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '地域表';

-- ----------------------------
-- Table structure for region_team
-- ----------------------------
CREATE TABLE IF NOT EXISTS `region_team`  (
  `region_id` bigint NOT NULL COMMENT '地域id',
  `type` enum('owner','worker') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '类型',
  `team_uuid` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '分组uuid',
  `checked_children` tinyint(1) NULL DEFAULT NULL COMMENT '是否包括子分组',
  `update_time` bigint NULL DEFAULT NULL COMMENT '更新标识',
...
CREATE TABLE IF NOT EXISTS `role`  (
  ...
  `rule` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '生效规则',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1079 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色授权表';
...
) ENGINE = InnoDB AUTO_INCREMENT = 933806994210819 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'autoexec_runner';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'autoexec_runner_map';
...
CREATE TABLE IF NOT EXISTS `runnergroup`  (
  ...
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '描述',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1136039253884929 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'runner组';
...
CREATE TABLE IF NOT EXISTS `runnergroup_network`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1102688899940353 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'autoexec_runnergroup_network';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'runner组和runner关系表';
...
CREATE TABLE IF NOT EXISTS `schedule_job_audit`  (
  ...
  INDEX `idx_end_time`(`end_time`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '定时作业日志表';
...
CREATE TABLE IF NOT EXISTS `schedule_job_audit_detail`  (
  ...
  PRIMARY KEY (`hash`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '定时作业日志详情表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '定时作业锁表';
...
) ENGINE = InnoDB AUTO_INCREMENT = 259 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '定时作业参数表';
...
CREATE TABLE IF NOT EXISTS `schedule_job_status`  (
  ...
  `fcd` timestamp(3) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`job_name`, `job_group`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '定时作业状态表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统公告表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统公告通知对象表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统公告用户接收表';
...
CREATE TABLE IF NOT EXISTS `tag`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '标签表';
...
CREATE TABLE IF NOT EXISTS `team`  (
  ...
  `source` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'web' COMMENT '数据来源',
  `fcd` timestamp(3) NULL DEFAULT NULL COMMENT '创建时间',
  `fcu` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `lcd` timestamp(3) NULL DEFAULT NULL COMMENT '最后更新时间',
  `lcu` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '修改人',
  ...
  INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '分组信息表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '分组与角色关系表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '分组领导职务关系表';
...
CREATE TABLE IF NOT EXISTS `theme`  (
  ...
  `fcd` timestamp(3) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '主题配置表';
...
CREATE TABLE IF NOT EXISTS `user`  (
  ...
  `is_super_admin` tinyint(1) NULL DEFAULT NULL COMMENT '是否超级管理员',
...
CREATE TABLE IF NOT EXISTS `user_agent`  (
  ...
  INDEX `idx_user_uuid`(`user_uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户授权代理表';
...
CREATE TABLE IF NOT EXISTS `user_authority`  (
  ...
  INDEX `id`(`id`) USING BTREE,
  INDEX `idx_auth`(`auth`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20428 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户授权表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户数据';
...
CREATE TABLE IF NOT EXISTS `user_password`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8460 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户密码表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户个性化配置';
...
) ENGINE = InnoDB AUTO_INCREMENT = 241827 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '角色成员关系表';
...
) ENGINE = InnoDB AUTO_INCREMENT = 212919 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '分组成员关系表';
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户职务表';
...
CREATE TABLE IF NOT EXISTS `worktime`  (
  ...
  PRIMARY KEY (`uuid`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '服务窗口';
