...
public interface SystemNoticeMapper {
    ...
    **/
    ...
    public int getHasReadSystemNoticeUserCountById(Long id);
    ...
    public int batchUpdateHasReadSystemNoticeUser(@Param("noticeId") Long id,@Param("limitNum") Integer limitNum);
